...
public class GzdtVillage implements Parcelable {
    ...
    public static final Creator<GzdtVillage> CREATOR = new Creator<GzdtVillage>() {
        public GzdtVillage createFromParcel(Parcel in) {
            return new GzdtVillage(in);
        }

        public GzdtVillage[] newArray(int size) {
            return new GzdtVillage[size];
        }
    };

    private GzdtVillage(Parcel in) {
        id = in.readLong();
        title = in.readString();
