 ...
 * @author dbz
 */
public class RdzjDbmlAdapter extends BaseAdapter {

    private List<TDbml> list = new ArrayList<TDbml>();
    private Context context;
    private ImageLoader mImageLoader;

    public RdzjDbmlAdapter(Context context, List<TDbml> list, ImageLoader mImageLoader) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            holder = new Holder();
            convertView = View.inflate(context, R.layout.rdzjdbml_item, null);
        ...
        String user = "职务:" + (list.get(position).getDanwei() == null ? "" : list.get(position)
                .getDanwei());
