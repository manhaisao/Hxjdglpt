...
public class NoticeAdapter extends BaseAdapter {
    ...
    public NoticeAdapter(Context context, List<Notice> list, ImageLoader mImageLoader) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.tvTitle = (TextView) convertView.findViewById(R.id.notice_item_title);
            holder.networkImageView = (NetworkImageView) convertView.findViewById(R.id.notice_img);
            holder.tvUser = (TextView) convertView.findViewById(R.id.notice_item_user);
            holder.tvTime = (TextView) convertView.findViewById(R.id.notice_item_time);
