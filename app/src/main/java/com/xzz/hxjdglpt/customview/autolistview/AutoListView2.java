package com.xzz.hxjdglpt.customview.autolistview;
...
public class AutoListView2 extends ListView implements OnScrollListener {
    ...
    public AutoListView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public AutoListView2(Context context, AttributeSet attrs, int defStyle) {
