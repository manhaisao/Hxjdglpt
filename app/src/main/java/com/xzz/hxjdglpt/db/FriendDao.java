...
public class FriendDao extends AbstractDao<Friend, String> {
    ...
    public static class Properties {
        public final static Property UserId = new Property(0, String.class, "userId", true,
                "USER_ID");
        public final static Property Name = new Property(1, String.class, "name", false, "NAME");
        public final static Property PortraitUri = new Property(2, String.class, "portraitUri",
                false, "PORTRAIT_URI");
        public final static Property DisplayName = new Property(3, String.class, "displayName",
                false, "DISPLAY_NAME");
        public final static Property DisplayPic = new Property(4, String.class, "diaplayPic",
                false, "DISPLAY_PIC");
    }
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'FRIEND' (" + //
                ...
                "'DISPLAY_PIC' TEXT);"); // 4: diaplayPic
        // Add Indexes
//        db.execSQL("CREATE INDEX " + constraint +
//                "IDX_FRIEND_NAME_DISPLAY_NAME_NAME_SPELLING_DISPLAY_NAME_SPELLING ON FRIEND" +
// " " +
//                "" + "" + "" + "" + "" + "(NAME,DISPLAY_NAME,NAME_SPELLING,
...
//                ";");
    ...
    protected void bindValues(SQLiteStatement stmt, Friend entity) {
        ...
        String displayPic = entity.getDiaplayPic();
        if (displayPic != null) {
            stmt.bindString(5, displayPic);
        }
    }
    ...
    public Friend readEntity(Cursor cursor, int offset) {
        Friend entity = new Friend( //
                ...
                cursor.isNull(offset + 2) ? null : Uri.parse(cursor.getString(offset + 2)), //
                // portraitUri
    ...
    public void readEntity(Cursor cursor, Friend entity, int offset) {
        ...
        entity.setPortraitUri(cursor.isNull(offset + 2) ? null : Uri.parse(cursor.getString
                (offset + 2)));
        entity.setDisplayName(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
        entity.setDiaplayPic(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
    }
