 ...
 * 养老保险-村
 */
@ContentView(R.layout.activity_ls_insurance_village)
public class LsInsuranceVillageActivity extends BaseActivity {
    ...
    private void getInsuranceByVillage() throws UnsupportedEncodingException {
        SuccinctProgress.showSuccinctProgress(LsInsuranceVillageActivity.this, "数据请求中···", SuccinctProgress
                .THEME_ULTIMATE, false, true);
        String url = ConstantUtil.BASE_URL + "/xshs/queryinfobyvnameandtype?type=1&vname=" + URLEncoder.encode(village.getName(), "utf-8");
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        //设置
                        tvInsuranceNum.setText(String.valueOf(yanglaos));
                        ...
                        DialogUtil.showTipsDialog(LsInsuranceVillageActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(LsInsuranceVillageActivity.this, R.string.load_fail);
                    }
