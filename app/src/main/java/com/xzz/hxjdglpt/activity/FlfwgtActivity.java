...
public class FlfwgtActivity extends  BaseActivity implements AutoListView.OnRefreshListener,
                    ...
                    public void onMySuccess(JSONObject result) {
                        ...
                        try {
                            ...
                            if ("1".equals(resultCode)) {
                                ...
                                DialogUtil.showTipsDialog(FlfwgtActivity.this);
                            } else if ("3".equals(resultCode)) {
                                ToastUtil.show(FlfwgtActivity.this, R.string.load_fail);
                            }
    ...
    private void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.hx_title_right:
                ...
                intent.setClass(FlfwgtActivity.this, GzdtFbActivity.class);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if (position - 1 < list.size()) {
            Intent intent = new Intent();
            intent.setClass(FlfwgtActivity.this, GzdtDetailActivity.class);
