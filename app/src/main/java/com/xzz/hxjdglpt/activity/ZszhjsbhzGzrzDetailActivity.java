 ...
 */
@ContentView(R.layout.aty_zszhjsbhz_gzrz_detail)
public class ZszhjsbhzGzrzDetailActivity extends BaseActivity implements View.OnTouchListener {
    ...
    private void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.hx_title_right:
                ...
                final Dialog dialog = new Dialog(ZszhjsbhzGzrzDetailActivity.this);
    ...
    private void delData() {
        SuccinctProgress.showSuccinctProgress(ZszhjsbhzGzrzDetailActivity.this, "数据提交中···",
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ToastUtil.show(ZszhjsbhzGzrzDetailActivity.this, R.string.del_success);
                        finish();
                    } else if ("2".equals(resultCode)) {
                        DialogUtil.showTipsDialog(ZszhjsbhzGzrzDetailActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(ZszhjsbhzGzrzDetailActivity.this, R.string.del_fail);
                    }
            ...
            if (path.length == fileName.length) {
                ...
                for (int i = 0; i < path.length; i++) {
                    if (!TextUtils.isEmpty(fileName[i]) || !TextUtils.isEmpty(path[i])) {
                        ...
                        int pxValue = DensityUtil.dip2px(ZszhjsbhzGzrzDetailActivity.this, 5);
                        ...
                        tv.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                if (fName.endsWith(".jpg") || fName.endsWith(".png") || fName
                                    ...
                                    intent.setClass(ZszhjsbhzGzrzDetailActivity.this,
                                            ShowImageActivity.class);
                                    startActivity(intent);
                                } else {
                                    File file = new File(ConstantUtil.BASE_PATH + fName);
                                    if (file.exists()) {
                                        Intent intent = new Intent(ZszhjsbhzGzrzDetailActivity
                                        ...
                                        final Dialog dialog = new Dialog(ZszhjsbhzGzrzDetailActivity
                                                .this);
                                        ...
                                        // .zxtz_detail_tip));
                                        tvCon.setText(ZszhjsbhzGzrzDetailActivity.this.getText(R
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case OkHttpManager.DOWNLOAD_SUCCESS:
                    ToastUtil.show(ZszhjsbhzGzrzDetailActivity.this, R.string.download_success);
                    times = 0;
                    dialog.dismiss();
                    break;
                case OkHttpManager.DOWNLOAD_FAIL:
                    ToastUtil.show(ZszhjsbhzGzrzDetailActivity.this, R.string.download_failed);
                    times = 0;
                    dialog.dismiss();
                    break;
                case OkHttpManager.NETWORK_FAILURE:
                    ToastUtil.show(ZszhjsbhzGzrzDetailActivity.this, R.string.net_unuser);
                    times = 0;
                    dialog.dismiss();
                    break;
                default:
