 ...
 */
@ContentView(R.layout.aty_already)
public class AlreadythingActivity extends BaseActivity implements AutoListView.OnRefreshListener,
    ...
    public void initView() {
        tvTitle.setText(R.string.ybsx);
        sxAdapter = new SxAdapter(this, list,3);
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        DialogUtil.showTipsDialog(AlreadythingActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(AlreadythingActivity.this, R.string.load_fail);
                    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if (position - 1 < list.size()) {
            ...
            intent.setClass(AlreadythingActivity.this, TaskDetailNewActivity.class);
