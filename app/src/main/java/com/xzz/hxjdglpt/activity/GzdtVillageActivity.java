...
import com.xzz.hxjdglpt.adapter.GzdtVillageAdapter;
...
public class GzdtVillageActivity extends BaseActivity implements AutoListView.OnRefreshListener,
    ...
    private User user;
    private GzdtVillageAdapter gzdtAdapter;
    ...
    private Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            List<GzdtVillage> result = (List<GzdtVillage>) msg.obj;
            switch (msg.what) {
    ...
    public void initView() {
        ...
        gzdtAdapter = new GzdtVillageAdapter(this, list);
    ...
    private void loadData(final int what) {
        String url = ConstantUtil.BASE_URL + "/gzdtvillage/queryGzdtByPage";
                    ...
                    public void onMySuccess(JSONObject result) {
                        ...
                        try {
                            ...
                            if ("1".equals(resultCode)) {
                                ...
                                Gson gson = new Gson();
                                List<GzdtVillage> newses = gson.fromJson(jsonArray.toString(), new
                                        TypeToken<List<GzdtVillage>>() {
                                        }.getType());
                                ...
                                DialogUtil.showTipsDialog(GzdtVillageActivity.this);
                            } else if ("3".equals(resultCode)) {
                                ToastUtil.show(GzdtVillageActivity.this, R.string.load_fail);
                            }
    ...
    private void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.hx_title_right:
                ...
                intent.setClass(GzdtVillageActivity.this, GzdtVillageFbActivity.class);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if (position - 1 < list.size()) {
            Intent intent = new Intent();
            intent.setClass(GzdtVillageActivity.this, GzdtVillageDetailActivity.class);
