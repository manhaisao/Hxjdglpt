...
public class FlfwConsultActivity extends BaseActivity {
        ...
        switch (v.getId()) {
            ...
            case R.id.fwmdm_commit:
                if (TextUtils.isEmpty(edtTitle.getText().toString())) {
                    ToastUtil.show(FlfwConsultActivity.this, R.string.fwmdm_title_null);
                } else if (TextUtils.isEmpty(edtDes.getText().toString())) {
                    ToastUtil.show(FlfwConsultActivity.this, R.string.fwmdm_des_null);
                } else {
                    commit();
                }
                break;
    ...
    private void commit() {
        SuccinctProgress.showSuccinctProgress(FlfwConsultActivity.this, "数据提交中···",
                SuccinctProgress.THEME_ULTIMATE, false, true);
        String url = ConstantUtil.BASE_URL + "/lawConsultations";
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("0".equals(resultCode)) {
                        ToastUtil.show(FlfwConsultActivity.this, R.string.commit_success);
                        finish();
                    } else if ("2".equals(resultCode)) {
                        DialogUtil.showTipsDialog(FlfwConsultActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(FlfwConsultActivity.this, R.string.commit_fail);
                    }
