 ...
 */
@ContentView(R.layout.aty_xfwd)
public class XfwdActivity extends BaseActivity implements View.OnTouchListener{
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if ((view.getId() == R.id.xfwd_bz && canVerticalScroll(edtBz))) {
        ...
        gridView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                if (position == 0 && imageItem.size() == ConstantUtil.ALL_IMAGE_COUNT) { //第一张为默认图片
                    ToastUtil.show(XfwdActivity.this, "图片数已至上限");
...
//                    startActivityForResult(intent, IMAGE_OPEN);
                    ...
                    intent.setClass(XfwdActivity.this, ShowImageActivity.class);
    ...
    protected void dialog(final int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(XfwdActivity.this);
    ...
    private void uploadFile(final String path) {
        SuccinctProgress.showSuccinctProgress(XfwdActivity.this, "图片上传中···", SuccinctProgress
        ...
        post = x.http().post(params, new Callback.CommonCallback<JSONObject>() {
            ...
            public void onSuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        DialogUtil.showTipsDialog(XfwdActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(XfwdActivity.this, R.string.load_fail);
                    }
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                SuccinctProgress.dismiss();
                ToastUtil.show(XfwdActivity.this, R.string.upload_image_fail);
            }
    ...
    @Event(value = {R.id.iv_back, R.id.xfwd_commit, R.id.xfwd_zdrq_add}, type = View
    ...
    private void onClick(View v) {
        switch (v.getId()) {
            case R.id.iv_back:
                finish();
                break;
            case R.id.xfwd_commit:
                commit();
                break;
            case R.id.xfwd_zdrq_add:
                Intent intent = new Intent();
                intent.putExtra("gridId", grid.getId());
                intent.putExtra("type", 56);
                intent.setClass(XfwdActivity.this, ListActivity.class);
                startActivity(intent);
                break;
        }
    }
     ...
     */
    private void commit() {
        String url = ConstantUtil.BASE_URL + "/xfwd/commitXfwd";
        ...
        if (!TextUtils.isEmpty(edtAjy.getText().toString())) {
            params.put("ajy", edtAjy.getText().toString());
        } else {
            params.put("ajy", "");
        }
        if (!TextUtils.isEmpty(edtAjyPhone.getText().toString())) {
            ...
            params.put("ajyphone", edtAjyPhone.getText().toString());
        } else {
            params.put("ajyphone", "");
        }
//        if (!TextUtils.isEmpty(edtZdrq.getText().toString())) {
//            params.put("zdrq", edtZdrq.getText().toString());
//        } else {
//            params.put("zdrq", "0");
//        }
        ...
        SuccinctProgress.showSuccinctProgress(XfwdActivity.this, "数据提交中···", SuccinctProgress
                .THEME_ULTIMATE, false, true);
        VolleyRequest.RequestPost(this, url, "zdrq_commit", params, new VolleyListenerInterface
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    String resultCode = result.getString("resultCode");
                    if ("1".equals(resultCode)) {
                        ToastUtil.show(XfwdActivity.this, R.string.commit_success);
                        finish();
                    } else if ("2".equals(resultCode)) {
                        DialogUtil.showTipsDialog(XfwdActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(XfwdActivity.this, R.string.commit_fail);
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    public void onStop() {
        ...
        BaseApplication.getRequestQueue().cancelAll("zdrq_commit");
    ...
    private void loadDataByGid() {
        SuccinctProgress.showSuccinctProgress(XfwdActivity.this, "请求数据中···", SuccinctProgress
                .THEME_ULTIMATE, false, true);
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        edtAjy.setText(sp.getBaMan() == null ? "" : sp.getBaMan());
                        edtAjyPhone.setText(sp.getBaManPhone() == null ? "" : sp.getBaManPhone());
                        tvZdrq.setText(sp.getZdrq() == null ? "" : sp.getZdrq());
                        edtBz.setText(sp.getBz() == null ? "" : sp.getBz());
                        if (sp.getPicpath() != null) {
                            picPath = sp.getPicpath();
                        }
//                        SuccinctProgress.showSuccinctProgress(XfwdActivity.this, "图片努力加载中···",
...
//                        new Thread(runnable).start();
        ...
        public void run() {
            ...
            for (int i = 0; i < ps.length; i++) {
                if (!TextUtils.isEmpty(ps[i])) {
                    mPath.add(ps[i]);
                    HashMap<String, Object> map = new HashMap<String, Object>();
                    map.put("itemImage", BitmapUtil.getNetBitmap(XfwdActivity.this, ConstantUtil
    ...
    public void onDestroy() {
        ...
        ((InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE))
                .hideSoftInputFromWindow(XfwdActivity.this.getCurrentFocus().getWindowToken(),
