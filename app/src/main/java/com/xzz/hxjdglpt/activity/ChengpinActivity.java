 ...
 */
@ContentView(R.layout.aty_chengpin)
public class ChengpinActivity extends BaseActivity implements View.OnTouchListener {
    ...
    public void initData() {
        if (!isAdd) {
            ...
            chengpin = getIntent().getParcelableExtra("chengpin");
            if (types[0].equals(chengpin.getType())) {
                spQylx.setSelection(0);
            } else if (types[1].equals(chengpin.getType())) {
                spQylx.setSelection(1);
            } else if (types[2].equals(chengpin.getType())) {
                spQylx.setSelection(2);
            }

            edtLxr.setText(chengpin.getFr());
            edtLxrPhone.setText(chengpin.getFrphone());
            edtSsdw.setText(chengpin.getDanwei());
            edtWgzrr.setText(chengpin.getGridzrr());
            edtWgzrrdh.setText(chengpin.getGridzrrphone());
            edtName.setText(chengpin.getName());//姓名
            edtBz.setText(chengpin.getBz());//备注
            edtAddress.setText(chengpin.getAddress());
            edtAqzrr.setText(chengpin.getAq());
            edtAqzrrPhone.setText(chengpin.getAqphone());
            if (chengpin.getFilepath() != null) {
                picPath = chengpin.getFilepath();
                SuccinctProgress.showSuccinctProgress(ChengpinActivity.this, "图片努力加载中···",
    ...
    public void initView() {
        types = getResources().getStringArray(R.array.chengpinyou);
        ...
        gridView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                if (position == 0 && imageItem.size() == 3) { //第一张为默认图片
                    ToastUtil.show(ChengpinActivity.this, "图片数已至上限");
...
//                    startActivityForResult(intent, IMAGE_OPEN);
                    ...
                    intent.setClass(ChengpinActivity.this, ShowImageActivity.class);
        ...
        public void run() {
            ...
            for (int i = 0; i < ps.length; i++) {
                if (!TextUtils.isEmpty(ps[i])) {
                    mPath.add(ps[i]);
                    HashMap<String, Object> map = new HashMap<String, Object>();
                    map.put("itemImage", BitmapUtil.getNetBitmap(ChengpinActivity.this,
    ...
    protected void dialog(final int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(ChengpinActivity.this);
    ...
    private void uploadFile(final String path) {
        SuccinctProgress.showSuccinctProgress(ChengpinActivity.this, "图片上传中···", SuccinctProgress
        ...
        post = x.http().post(params, new Callback.CommonCallback<JSONObject>() {
            ...
            public void onSuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        DialogUtil.showTipsDialog(ChengpinActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(ChengpinActivity.this, R.string.load_fail);
                    }
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                SuccinctProgress.dismiss();
                ToastUtil.show(ChengpinActivity.this, R.string.upload_image_fail);
            }
        ...
        switch (v.getId()) {
            ...
            case R.id.c_commit:
                if (TextUtils.isEmpty(edtName.getText().toString())) {
                    ToastUtil.show(ChengpinActivity.this, "请输入名称！");
                    return;
                }
                if (isAdd) {
                    commit();
     ...
     */
    private void commit() {
        String url = ConstantUtil.BASE_URL + "/cpy/commitData";
        ...
        SuccinctProgress.showSuccinctProgress(ChengpinActivity.this, "请求提交中···", SuccinctProgress
                .THEME_ULTIMATE, false, true);
                ...
                VolleyListenerInterface(this, VolleyListenerInterface.mListener,
                    ...
                    public void onMySuccess(JSONObject result) {
                        ...
                        try {
                            String resultCode = result.getString("resultCode");
                            if ("1".equals(resultCode)) {
                                ToastUtil.show(ChengpinActivity.this, R.string.commit_success);
                                finish();
                            } else if ("2".equals(resultCode)) {
                                DialogUtil.showTipsDialog(ChengpinActivity.this);
                            } else if ("3".equals(resultCode)) {
                                ToastUtil.show(ChengpinActivity.this, R.string.commit_fail);
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
     ...
     */
    private void update() {
        String url = ConstantUtil.BASE_URL + "/cpy/updateData";
        Map<String, String> params = new HashMap<String, String>();
        params.put("userId", user.getUserId());
        params.put("token", user.getToken());
        params.put("id", String.valueOf(chengpin.getId()));
        params.put("gridid", gridId);
        params.put("type", spQylx.getSelectedItem().toString());
        if (!TextUtils.isEmpty(edtLxr.getText().toString())) {
            params.put("fr", edtLxr.getText().toString());
        ...
        VolleyRequest.RequestPost(this, url, "updateCompany", params, new VolleyListenerInterface
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    String resultCode = result.getString("resultCode");
                    if ("1".equals(resultCode)) {
                        ToastUtil.show(ChengpinActivity.this, R.string.modify_success);
                        finish();
                    } else if ("2".equals(resultCode)) {
                        DialogUtil.showTipsDialog(ChengpinActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(ChengpinActivity.this, R.string.modify_fail);
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
