...
public class GzzdtDtDetailActivity extends BaseActivity {
...
//        }
    ...
    private void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.hx_btn_right:
                ...
                final Dialog dialog = new Dialog(GzzdtDtDetailActivity.this);
    ...
    private void delData() {
        SuccinctProgress.showSuccinctProgress(GzzdtDtDetailActivity.this, "数据提交中···",
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ToastUtil.show(GzzdtDtDetailActivity.this, R.string.del_success);
                        finish();
                    } else if ("2".equals(resultCode)) {
                        DialogUtil.showTipsDialog(GzzdtDtDetailActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(GzzdtDtDetailActivity.this, R.string.del_fail);
                    }
    ...
    private class NineGridAdapter extends CommonAdapter<String> {
        ...
        public NineGridAdapter() {
            super(GzzdtDtDetailActivity.this, R.layout.item_grid_image, sourceImageList);
        }
