 ...
 * 部门经办人
 */
@ContentView(R.layout.activity_ls_collect_03_jbr)
public class LsCollect03JbrActivity extends BaseActivity{
    ...
    private int pid;
    private BaozhangJbr baozhangJbr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        baozhangJbr = (BaozhangJbr) bundle.getSerializable("baozhangJbr");
        x.view().inject(this);
        initView();
        initData();
    }
    ...
    public void initView() {
        ...
        if(!isAdd){
            id = baozhangJbr.getId();
            etBmfzr.setText(baozhangJbr.getJbr());
            etFzrdh.setText(baozhangJbr.getJbrphone());
        }
    }
     ...
     */
    private void formSb() {
        SuccinctProgress.showSuccinctProgress(LsCollect03JbrActivity.this, "数据请求中···", SuccinctProgress
        ...
        if(!isAdd){
            params.put("id",String.valueOf(baozhangJbr.getId()));
        }
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ToastUtil.show(LsCollect03JbrActivity.this, R.string.commit_success);
                        LsCollect03JbrActivity.this.finish();
                    } else if ("2".equals(resultCode)) {
                        DialogUtil.showTipsDialog(LsCollect03JbrActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(LsCollect03JbrActivity.this, R.string.load_fail);
                    }
