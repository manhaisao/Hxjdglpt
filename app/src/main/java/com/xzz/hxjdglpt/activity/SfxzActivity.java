 ...
 */
@ContentView(R.layout.aty_sfxz)
public class SfxzActivity extends BaseActivity implements View.OnTouchListener {
    @ViewInject(R.id.hx_title)
    private TextView tvTitle;
    @ViewInject(R.id.iv_back)
    private ImageView ivBack;
    @ViewInject(R.id.sfxz_commit)
    private Button btnCommit;

    @ViewInject(R.id.sfxz_zrr)
    private EditText edtZrr;
    @ViewInject(R.id.sfxz_zrrphone)
    private EditText edtZrrPhone;
    //    @ViewInject(R.id.sfxz_jsb)
//    private TextView edtJsb;//肇事肇祸精神病患者
//    @ViewInject(R.id.sfxz_zdqsn)
//    private EditText edtZdqsn;//重点青少年
//    @ViewInject(R.id.sfxz_sqfx)
//    private EditText edtSqfx;//社区服刑
//    @ViewInject(R.id.sfxz_sqjdry)
//    private EditText edtSqjd;//社区戒毒人员
//    @ViewInject(R.id.sfxz_xjry)
//    private EditText edtXjry;//邪教人员
//    @ViewInject(R.id.sfxz_azbj)
//    private EditText edtAzbj;//安置帮教人员
    @ViewInject(R.id.sfxz_bz)
    ...
    @ViewInject(R.id.sfxz_jsb)
    private TextView tvJsbhz;//精神病患者
    @ViewInject(R.id.sfxz_zdqsn)
    private TextView tvZdqsn;//重点青少年
    @ViewInject(R.id.sfxz_sqjdry)
    private TextView tvJdry;//社区戒毒人员
    @ViewInject(R.id.sfxz_xjry)
    private TextView tvXjry;//邪教人员
    @ViewInject(R.id.sfxz_sqfx)
    private TextView tvSqfx;//社区服刑
    @ViewInject(R.id.sfxz_azbj)
    private TextView tvAzbj;//安置帮办
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if ((view.getId() == R.id.sfxz_bz && canVerticalScroll(edtBz))) {
        ...
        gridView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                if (position == 0 && imageItem.size() == ConstantUtil.ALL_IMAGE_COUNT) { //第一张为默认图片
                    ToastUtil.show(SfxzActivity.this, "图片数已至上限");
...
//                    startActivityForResult(intent, IMAGE_OPEN);
                    ...
                    intent.setClass(SfxzActivity.this, ShowImageActivity.class);
    ...
    protected void dialog(final int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(SfxzActivity.this);
    ...
    private void uploadFile(final String path) {
        SuccinctProgress.showSuccinctProgress(SfxzActivity.this, "图片上传中···", SuccinctProgress
        ...
        post = x.http().post(params, new Callback.CommonCallback<JSONObject>() {
            ...
            public void onSuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        DialogUtil.showTipsDialog(SfxzActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(SfxzActivity.this, R.string.load_fail);
                    }
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                SuccinctProgress.dismiss();
                ToastUtil.show(SfxzActivity.this, R.string.upload_image_fail);
            }
    ...
    @Event(value = {R.id.iv_back, R.id.sfxz_commit, R.id.sfxz_add_djy, R.id.sfxz_add_xxy, R.id
            .sfxz_add_xcy, R.id.sfxz_add_zyz, R.id.sfxz_add_flgw, R.id.sfxz_add_jsb, R.id
            .sfxz_add_qsn, R.id.sfxz_add_sqjdry, R.id.sfxz_add_xjry, R.id.sfxz_add_sqfx, R.id
            .sfxz_add_azbj}, type = View.OnClickListener.class)
    private void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.iv_back:
                finish();
                break;
            case R.id.sfxz_commit:
                commit();
                break;
            case R.id.sfxz_add_djy:
                intent.putExtra("type", 21);
                intent.setClass(SfxzActivity.this, ListActivity.class);
                startActivity(intent);
                break;
            case R.id.sfxz_add_xxy:
                intent.putExtra("type", 22);
                intent.setClass(SfxzActivity.this, ListActivity.class);
                startActivity(intent);
                break;
            case R.id.sfxz_add_xcy:
                intent.putExtra("type", 23);
                intent.setClass(SfxzActivity.this, ListActivity.class);
                startActivity(intent);
                break;
            case R.id.sfxz_add_zyz:
                intent.putExtra("type", 24);
                intent.setClass(SfxzActivity.this, ListActivity.class);
                startActivity(intent);
                break;
            case R.id.sfxz_add_flgw:
                intent.putExtra("type", 25);
                intent.setClass(SfxzActivity.this, ListActivity.class);
                startActivity(intent);
                break;
            case R.id.sfxz_add_jsb:
                intent.putExtra("type", 57);
                intent.setClass(SfxzActivity.this, ListActivity.class);
                startActivity(intent);
                break;
            case R.id.sfxz_add_qsn:
                intent.putExtra("type", 58);
                intent.setClass(SfxzActivity.this, ListActivity.class);
                startActivity(intent);
                break;
            case R.id.sfxz_add_sqjdry:
                intent.putExtra("type", 59);
                intent.setClass(SfxzActivity.this, ListActivity.class);
                startActivity(intent);
                break;
            case R.id.sfxz_add_xjry:
                intent.putExtra("type", 60);
                intent.setClass(SfxzActivity.this, ListActivity.class);
                startActivity(intent);
                break;
            case R.id.sfxz_add_sqfx:
                intent.putExtra("type", 61);
                intent.setClass(SfxzActivity.this, ListActivity.class);
                startActivity(intent);
                break;
            case R.id.sfxz_add_azbj:
     ...
     */
    private void commit() {
        String url = ConstantUtil.BASE_URL + "/sfxz/commitSfxz";
...
//        if (!TextUtils.isEmpty(edtJsb.getText().toString())) {
//            params.put("jsb", edtJsb.getText().toString());
//        } else {
//            params.put("jsb", "0");
//        }
//        if (!TextUtils.isEmpty(edtAzbj.getText().toString())) {
//            params.put("azbj", edtAzbj.getText().toString());
//        } else {
//            params.put("azbj", "0");
//        }
//        if (!TextUtils.isEmpty(edtSqfx.getText().toString())) {
//            params.put("sqfx", edtSqfx.getText().toString());
//        } else {
//            params.put("sqfx", "0");
//        }
//        if (!TextUtils.isEmpty(edtSqjd.getText().toString())) {
//            params.put("sqjd", edtSqjd.getText().toString());
//        } else {
//            params.put("sqjd", "0");
//        }
//        if (!TextUtils.isEmpty(edtXjry.getText().toString())) {
//            params.put("xjry", edtXjry.getText().toString());
//        } else {
//            params.put("xjry", "0");
//        }
//        if (!TextUtils.isEmpty(edtZdqsn.getText().toString())) {
//            params.put("zdqsn", edtZdqsn.getText().toString());
//        } else {
//            params.put("zdqsn", "0");
//        }
        ...
        SuccinctProgress.showSuccinctProgress(SfxzActivity.this, "数据提交中···", SuccinctProgress
                .THEME_ULTIMATE, false, true);
        VolleyRequest.RequestPost(this, url, "sfxz_commit", params, new VolleyListenerInterface
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    String resultCode = result.getString("resultCode");
                    if ("1".equals(resultCode)) {
                        ToastUtil.show(SfxzActivity.this, R.string.commit_success);
                        finish();
                    } else if ("2".equals(resultCode)) {
                        DialogUtil.showTipsDialog(SfxzActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(SfxzActivity.this, R.string.commit_fail);
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    public void onStop() {
        ...
        BaseApplication.getRequestQueue().cancelAll("sfxz_commit");
    ...
    private void loadDataByGid() {
        SuccinctProgress.showSuccinctProgress(SfxzActivity.this, "请求数据中···", SuccinctProgress
                .THEME_ULTIMATE, false, true);
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        Sfxz sp = (Sfxz) gson.fromJson(result.getJSONObject("data").toString(),
                                Sfxz.class);
                        edtZrr.setText(sp.getHeadname() == null ? "" : sp.getHeadname());
                        ...
                        tvJdry.setText(String.valueOf(sp.getSqjd()));
                        tvAzbj.setText(String.valueOf(sp.getAzbjry()));
                        tvJsbhz.setText(String.valueOf(sp.getZsjsb()));
                        edtBz.setText(sp.getRemark() == null ? "" : sp.getRemark());
...
//                        SuccinctProgress.showSuccinctProgress(SfxzActivity.this, "图片努力加载中···",
...
//                        new Thread(runnable).start();
        ...
        public void run() {
            ...
            for (int i = 0; i < ps.length; i++) {
                if (!TextUtils.isEmpty(ps[i])) {
                    mPath.add(ps[i]);
                    HashMap<String, Object> map = new HashMap<String, Object>();
                    map.put("itemImage", BitmapUtil.getNetBitmap(SfxzActivity.this, ConstantUtil
    ...
    public void onDestroy() {
        ...
        ((InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE))
                .hideSoftInputFromWindow(SfxzActivity.this.getCurrentFocus().getWindowToken(),
