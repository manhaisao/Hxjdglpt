 ...
 * 网格养老保险明细
 */
@ContentView(R.layout.activity_ls_insurance_village_secondary)
public class LsInsuranceVillageSecondaryActivity extends BaseActivity {
...
//                SuccinctProgress.dismiss();
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        DialogUtil.showTipsDialog(LsInsuranceVillageSecondaryActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(LsInsuranceVillageSecondaryActivity.this, R.string.load_fail);
                    }
...
//                SuccinctProgress.dismiss();
    ...
    private void getGridInfo(){
        SuccinctProgress.showSuccinctProgress(LsInsuranceVillageSecondaryActivity.this, "数据请求中···", SuccinctProgress
                .THEME_ULTIMATE, false, true);
        String url = ConstantUtil.BASE_URL + "/xshs/selectbyid?gridid="+gId+"&type=1";
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        LsGrid lsGrid = (LsGrid) gson.fromJson(result.getJSONObject("data").toString
                                (), LsGrid.class);
                        tvInsuranceNum.setText(lsGrid.getYlbx());
