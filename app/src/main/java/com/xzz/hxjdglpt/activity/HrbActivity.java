...
import com.xzz.hxjdglpt.adapter.HrbAdapter;
...
public class HrbActivity extends BaseActivity implements OnRefreshListener,
    ...
    private User user;
    private HrbAdapter newsAdapter;
    ...
    private Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            List<Haoren> result = (List<Haoren>) msg.obj;
            switch (msg.what) {
    ...
    public void initView() {
        tvTitle.setText("好人榜");
        newsAdapter = new HrbAdapter(this, list, mImageLoader);
    ...
    private void loadData(final int what) {
        String url = ConstantUtil.BASE_URL + "/hr/queryListByPage";
                    ...
                    public void onMySuccess(JSONObject result) {
                        ...
                        try {
                            ...
                            if ("1".equals(resultCode)) {
                                ...
                                Gson gson = new Gson();
                                List<Haoren> newses = gson.fromJson(jsonArray.toString(), new TypeToken<List<Haoren>>() {
                                }.getType());
                                ...
                                DialogUtil.showTipsDialog(HrbActivity.this);
                            } else if ("3".equals(resultCode)) {
                                ToastUtil.show(HrbActivity.this, R.string.load_fail);
                            }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if (position - 1 < list.size()) {
            ...
            intent.setClass(HrbActivity.this, HrbDetailActivity.class);
            Bundle bundle = new Bundle();
            bundle.putParcelable("hrb", list.get(position - 1));
