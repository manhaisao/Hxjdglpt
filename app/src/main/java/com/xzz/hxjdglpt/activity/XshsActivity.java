 ...
 */
@ContentView(R.layout.aty_xshs)
public class XshsActivity extends BaseActivity implements View.OnTouchListener{
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if ((view.getId() == R.id.xshs_bz && canVerticalScroll(edtBz))) {
        ...
        gridView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                if (position == 0 && imageItem.size() == ConstantUtil.ALL_IMAGE_COUNT) { //第一张为默认图片
                    ToastUtil.show(XshsActivity.this, "图片数已至上限");
...
//                    startActivityForResult(intent, IMAGE_OPEN);
                    ...
                    intent.setClass(XshsActivity.this, ShowImageActivity.class);
    ...
    protected void dialog(final int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(XshsActivity.this);
    ...
    private void uploadFile(final String path) {
        SuccinctProgress.showSuccinctProgress(XshsActivity.this, "图片上传中···", SuccinctProgress
        ...
        post = x.http().post(params, new Callback.CommonCallback<JSONObject>() {
            ...
            public void onSuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        DialogUtil.showTipsDialog(XshsActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(XshsActivity.this, R.string.load_fail);
                    }
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                SuccinctProgress.dismiss();
                ToastUtil.show(XshsActivity.this, R.string.upload_image_fail);
            }
    ...
    @Event(value = {R.id.iv_back, R.id.xshs_commit, R.id.xshs_add_qy, R.id.xshs_add_gt}, type =
    ...
    private void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.iv_back:
                finish();
                break;
            case R.id.xshs_commit:
                commit();
                break;
            case R.id.xshs_add_qy:
                intent.putExtra("type", 4);
                intent.setClass(XshsActivity.this, ListActivity.class);
                startActivity(intent);
                break;
            case R.id.xshs_add_gt:
    ...
    private void commit() {
        ...
        String url = ConstantUtil.BASE_URL + "/xshs/commitXshs";
        ...
        if (!TextUtils.isEmpty(edtHys.getText().toString())) {
            params.put("hsy", edtHys.getText().toString());
        } else {
            params.put("hsy", "");
        }
        if (!TextUtils.isEmpty(edtHsyPhone.getText().toString())) {
            ...
            params.put("hsyhone", edtHsyPhone.getText().toString());
        } else {
            params.put("hsyhone", "");
        }
        ...
        SuccinctProgress.showSuccinctProgress(XshsActivity.this, "数据提交中···", SuccinctProgress
                .THEME_ULTIMATE, false, true);
        VolleyRequest.RequestPost(this, url, "fwzw_commit", params, new VolleyListenerInterface
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    String resultCode = result.getString("resultCode");
                    if ("1".equals(resultCode)) {
                        ToastUtil.show(XshsActivity.this, R.string.commit_success);
                        finish();
                    } else if ("2".equals(resultCode)) {
                        DialogUtil.showTipsDialog(XshsActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(XshsActivity.this, R.string.commit_fail);
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    private void loadDataByGid() {
        SuccinctProgress.showSuccinctProgress(XshsActivity.this, "请求数据中···", SuccinctProgress
                .THEME_ULTIMATE, false, true);
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        edtHys.setText(sp.getHsy() == null ? "" : sp.getHsy());
                        edtHsyPhone.setText(sp.getHsyphone() == null ? "" : sp.getHsyphone());
...
//                        SuccinctProgress.showSuccinctProgress(XshsActivity.this, "图片努力加载中···",
...
//                        new Thread(runnable).start();
        ...
        public void run() {
            ...
            for (int i = 0; i < ps.length; i++) {
                if (!TextUtils.isEmpty(ps[i])) {
                    mPath.add(ps[i]);
                    HashMap<String, Object> map = new HashMap<String, Object>();
                    map.put("itemImage", BitmapUtil.getNetBitmap(XshsActivity.this, ConstantUtil
    ...
    public void onDestroy() {
        ...
        ((InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE))
                .hideSoftInputFromWindow(XshsActivity.this.getCurrentFocus().getWindowToken(),
