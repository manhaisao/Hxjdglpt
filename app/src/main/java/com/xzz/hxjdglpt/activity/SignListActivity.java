...
import com.xzz.hxjdglpt.adapter.SignAdapter;
...
@ContentView(R.layout.aty_sign_list)
public class SignListActivity extends BaseActivity implements OnRefreshListener, OnLoadListener {
    ...
    private Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            List<Qd> result = (List<Qd>) msg.obj;
            switch (msg.what) {
    ...
    private void loadData(final int what) {
        String url = ConstantUtil.BASE_URL + "/qd/queryQdByUserIdAndTime";
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        Gson gson = new Gson();
                        List<Qd> data = gson.fromJson(jsonArray.toString(), new
                                TypeToken<List<Qd>>() {
                        }.getType());
                        ...
                        DialogUtil.showTipsDialog(SignListActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(SignListActivity.this, R.string.load_fail);
                    }
