 ...
 */
@ContentView(R.layout.aty_tezhongweixian_info)
public class TezhongweixianInfo extends BaseActivity {
    ...
    private TextView mFrdh;

    @ViewInject(R.id.company_aqyzrr)
    private TextView mAqzrr;
    @ViewInject(R.id.company_aqzrrdh)
    private TextView mAqzrrdh;
    ...
    public void initView() {
        tvTitle.setText(tezhongweixian.getType());
        if (type == 1) {
        ...
        gridView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                intent.setClass(TezhongweixianInfo.this, ShowImageActivity.class);
...
//            loadData();
        mName.setText(tezhongweixian.getName());
        mGrid.setText(tezhongweixian.getGridid());
        mQylx.setText(tezhongweixian.getType());
        mNsqk.setText(tezhongweixian.getAddress());
        mZrr.setText(tezhongweixian.getGridzrr());
        mZrrdh.setText(tezhongweixian.getGridzrrphone());
        mDw.setText(tezhongweixian.getDanwei());
        mBz.setText(tezhongweixian.getBz());
        mFr.setText(tezhongweixian.getFr());
        mFrdh.setText(tezhongweixian.getFrphone());
        mAqzrr.setText(tezhongweixian.getAq());
        mAqzrrdh.setText(tezhongweixian.getAqphone());
        if (tezhongweixian.getFilepath() != null) {
            picPath = tezhongweixian.getFilepath();
            SuccinctProgress.showSuccinctProgress(TezhongweixianInfo.this, "图片努力加载中···",
        ...
        public void run() {
            ...
            for (int i = 0; i < ps.length; i++) {
                if (!TextUtils.isEmpty(ps[i])) {
                    ...
                    map.put("itemImage", BitmapUtil.getNetBitmap(TezhongweixianInfo.this, ConstantUtil
    ...
    private void loadData() {
        SuccinctProgress.showSuccinctProgress(TezhongweixianInfo.this, "数据请求中···", SuccinctProgress
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        DialogUtil.showTipsDialog(TezhongweixianInfo.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(TezhongweixianInfo.this, R.string.load_fail);
                    }
    ...
    private void onClick(View v) {
        Intent intent = new Intent();
        intent.setClass(TezhongweixianInfo.this, XfaqActivity.class);
        intent.putExtra("type", type);
        intent.putExtra("cType", "5");
        intent.putExtra("pId", String.valueOf(tezhongweixian.getId()));
        switch (v.getId()) {
            case R.id.iv_back:
                finish();
                break;
