...
public class WgqyActivity  extends  BaseActivity  implements AutoListView.OnRefreshListener,
    ...
    private void loadData(final int what) {
        String url = ConstantUtil.BASE_URL + "/tWgqyInfo?pageNum=" + pageIndex + "&pageSize=20";
...
//                LogUtil.i(result.toString());
                try {
                    ...
                    if ("0".equals(resultCode)) {
                        ...
                        DialogUtil.showTipsDialog(WgqyActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(WgqyActivity.this, R.string.load_fail);
                    }
