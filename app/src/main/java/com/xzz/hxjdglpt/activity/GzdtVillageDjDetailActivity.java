 ...
 */
@ContentView(R.layout.aty_gzdt_dj_detail)
public class GzdtVillageDjDetailActivity extends BaseActivity {
    ...
    @ViewInject(R.id.gzdt_detail_lx)
    private TextView tvLx;

    private GzdtVillageDj gzdt;
    private User user;
    ...
    public void initData() {
        ...
        if (gzdt.getType() == 1) {
            tvLx.setText(types[0]);
        } else if (gzdt.getType() == 2) {
            tvLx.setText(types[1]);
        } else if (gzdt.getType() == 3) {
            tvLx.setText(types[2]);
        } else if (gzdt.getType() == 4) {
            tvLx.setText(types[3]);
        }
    ...
    private void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.hx_title_right:
                ...
                final Dialog dialog = new Dialog(GzdtVillageDjDetailActivity.this);
    ...
    private void delData() {
        SuccinctProgress.showSuccinctProgress(GzdtVillageDjDetailActivity.this, "数据提交中···",
                SuccinctProgress.THEME_ULTIMATE, false, true);
        String url = "";
        HashMap<String, String> params = new HashMap<>();
        url = ConstantUtil.BASE_URL + "/gzdtvillagedj/deleteGzdt";
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ToastUtil.show(GzdtVillageDjDetailActivity.this, R.string.del_success);
                        finish();
                    } else if ("2".equals(resultCode)) {
                        DialogUtil.showTipsDialog(GzdtVillageDjDetailActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(GzdtVillageDjDetailActivity.this, R.string.del_fail);
                    }
            ...
            if (path.length == fileName.length) {
                ...
                for (int i = 0; i < path.length; i++) {
                    if (!TextUtils.isEmpty(fileName[i]) || !TextUtils.isEmpty(path[i])) {
                        ...
                        int pxValue = DensityUtil.dip2px(GzdtVillageDjDetailActivity.this, 5);
                        ...
                        tv.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                if (fName.endsWith(".jpg") || fName.endsWith(".png") || fName
                                    ...
                                    intent.setClass(GzdtVillageDjDetailActivity.this, ShowImageActivity
                                            .class);
                                    startActivity(intent);
                                } else {
                                    File file = new File(ConstantUtil.BASE_PATH + fName);
                                    if (file.exists()) {
                                        Intent intent = new Intent(GzdtVillageDjDetailActivity.this,
                                        ...
                                        // .zxtz_detail_tip));
                                        tvCon.setText(GzdtVillageDjDetailActivity.this.getText(R.string
                                                .zxtz_detail_content));
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case OkHttpManager.DOWNLOAD_SUCCESS:
                    ToastUtil.show(GzdtVillageDjDetailActivity.this, R.string.download_success);
                    times = 0;
                    dialog.dismiss();
                    break;
                case OkHttpManager.DOWNLOAD_FAIL:
                    ToastUtil.show(GzdtVillageDjDetailActivity.this, R.string.download_failed);
                    times = 0;
                    dialog.dismiss();
                    break;
                case OkHttpManager.NETWORK_FAILURE:
                    ToastUtil.show(GzdtVillageDjDetailActivity.this, R.string.net_unuser);
                    times = 0;
                    dialog.dismiss();
                    break;
                default:
