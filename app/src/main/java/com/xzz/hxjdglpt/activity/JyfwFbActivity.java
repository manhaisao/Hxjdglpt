 ...
 */
@ContentView(R.layout.aty_jyfw_fb)
public class JyfwFbActivity extends BaseActivity implements View.OnTouchListener {
    ...
    @ViewInject(R.id.jyfe_fb_commit)
    private Button btnCommit;
    @ViewInject(R.id.jyfe_fb_title)
    private EditText edtTitle;
    @ViewInject(R.id.jyfe_fb_content)
        ...
        gridView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                if (position == 0 && imageItem.size() == ConstantUtil.ALL_IMAGE_COUNT) { //第一张为默认图片
                    ToastUtil.show(JyfwFbActivity.this, "图片数已至上限");
...
//                    startActivityForResult(intent, IMAGE_OPEN);
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if ((view.getId() == R.id.jyfe_fb_content && canVerticalScroll(edtContent))) {
    ...
    @Event(value = {R.id.iv_back, R.id.jyfe_fb_commit}, type = View.OnClickListener.class)
    private void onClick(View v) {
        switch (v.getId()) {
            case R.id.iv_back:
                finish();
                break;
            case R.id.jyfe_fb_commit:
                commit();
                break;
        }
    }
    ...
    */
    protected void dialog(final int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(JyfwFbActivity.this);
    ...
    private void uploadFile(final String path) {
        SuccinctProgress.showSuccinctProgress(JyfwFbActivity.this, "图片上传中···", SuccinctProgress
        ...
        post = x.http().post(params, new Callback.CommonCallback<JSONObject>() {
            ...
            public void onSuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        DialogUtil.showTipsDialog(JyfwFbActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(JyfwFbActivity.this, R.string.load_fail);
                    }
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                SuccinctProgress.dismiss();
                ToastUtil.show(JyfwFbActivity.this, R.string.upload_image_fail);
            }
    ...
    private void commit() {
        ...
        SuccinctProgress.showSuccinctProgress(JyfwFbActivity.this, "数据提交中···", SuccinctProgress
                .THEME_ULTIMATE, false, true);
        String url = ConstantUtil.BASE_URL + "/jyfw/commitJyfw";
        ...
        VolleyRequest.RequestPost(this, url, "commitJyfw", params, new VolleyListenerInterface
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    String resultCode = result.getString("resultCode");
                    if ("1".equals(resultCode)) {
                        ToastUtil.show(JyfwFbActivity.this, R.string.commit_success);
                        finish();
                    } else if ("2".equals(resultCode)) {
                        DialogUtil.showTipsDialog(JyfwFbActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(JyfwFbActivity.this, R.string.commit_fail);
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    public void onStop() {
        super.onStop();
        BaseApplication.getRequestQueue().cancelAll("commitJyfw");
    }
