 ...
 * 城乡居民基本养老保险信息
 */
@ContentView(R.layout.activity_ls_collect_05)
public class LsCollect05Activity extends BaseActivity{
    ...
    private void getInit() {
        String url = ConstantUtil.BASE_URL + "/xshs/queryinfo?type=1";
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        DialogUtil.showTipsDialog(LsCollect05Activity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(LsCollect05Activity.this, R.string.load_fail);
                    }
     ...
     */
    private void formSb() {
        SuccinctProgress.showSuccinctProgress(LsCollect05Activity.this, "数据请求中···", SuccinctProgress
        ...
        VolleyRequest.RequestPost(this, url, "updateUserjichu", params, new VolleyListenerInterface
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    ...
                    // resultCode 1:成功查询 ；2：token不一致；3：查询失败
                    if ("1".equals(resultCode)) {
                        ToastUtil.show(LsCollect05Activity.this,R.string.commit_success);
                        LsCollect05Activity.this.finish();
                    } else if ("2".equals(resultCode)) {
                        DialogUtil.showTipsDialog(LsCollect05Activity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(LsCollect05Activity.this, R.string.load_fail);
