...
public class JpzsActivity extends  BaseActivity implements AutoListView.OnRefreshListener,
...
//        }
    ...
    private void loadData(final int what) {
        String url = ConstantUtil.BASE_URL + "/jpzs?pageNum="+pageIndex+"&pageSize="+ConstantUtil.PAGE_SIZE;
        VolleyRequest.RequestGet(this, url, "jpzs", new
                    ...
                    public void onMySuccess(JSONObject result) {
                        ...
                        try {
                            ...
                            if ("0".equals(resultCode)) {
                                ...
                                DialogUtil.showTipsDialog(JpzsActivity.this);
                            } else if ("3".equals(resultCode)) {
                                ToastUtil.show(JpzsActivity.this, R.string.load_fail);
                            }
    ...
    public void onStop() {
        super.onStop();
        BaseApplication.getRequestQueue().cancelAll("jpzs");
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if (position - 1 < list.size()) {
            ...
            intent.setClass(JpzsActivity.this, JpzsDetailActivity.class);
