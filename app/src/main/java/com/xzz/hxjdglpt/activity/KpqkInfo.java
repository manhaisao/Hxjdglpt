 ...
 */
@ContentView(R.layout.aty_kpqk_info)
public class KpqkInfo extends BaseActivity {
    ...
    private void loadData() {
        SuccinctProgress.showSuccinctProgress(KpqkInfo.this, "数据请求中···", SuccinctProgress
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        Gson gson = new Gson();
                        jd = (Kpqk) gson.fromJson(result.getJSONObject("data").toString(),
                                Kpqk.class);
                        edtZe.setText(jd.getJe());
                        edtBz.setText(jd.getBz());
                    } else if ("2".equals(resultCode)) {
                        DialogUtil.showTipsDialog(KpqkInfo.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(KpqkInfo.this, R.string.load_fail);
                    } else if ("4".equals(resultCode)) {
                        //没有查到的情况
                        ToastUtil.show(KpqkInfo.this, "暂无纳税信息");
                    }
