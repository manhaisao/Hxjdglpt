 ...
 */
@ContentView(R.layout.aty_cityinfo_info)
public class CityInfoInfo extends BaseActivity {
    ...
    private int type;
    @ViewInject(R.id.cityinfo_d_name)
    private TextView mName;
    @ViewInject(R.id.cityinfo_d_t_name)
    private TextView tvName;
    @ViewInject(R.id.cityinfo_d_cun)
    private TextView mCun;
    @ViewInject(R.id.cityinfo_d_grid)
    private TextView mGrid;

    @ViewInject(R.id.cityinfo_d_t_dy)
    private TextView tvDy;
    @ViewInject(R.id.cityinfo_d_dy)
    private TextView mDy;
    @ViewInject(R.id.cityinfo_d_t_phone)
    private TextView tvPhone;
    @ViewInject(R.id.cityinfo_d_phone)
    private TextView mPhone;
    @ViewInject(R.id.cityinfo_d_bz)
...
//        path = cjry.getPicpath().split(",");
    ...
    public void initView() {
        switch (type) {
            case 17:
                ...
                tvName.setText("道路名称：");
                tvDy.setVisibility(View.GONE);
                mDy.setVisibility(View.GONE);
            ...
            case 19:
                ...
                tvName.setText("姓名：");
                tvDy.setVisibility(View.VISIBLE);
                mDy.setVisibility(View.VISIBLE);
                tvPhone.setVisibility(View.VISIBLE);
                mPhone.setVisibility(View.VISIBLE);
                mDy.setText(cityInfo.getDaiyu());
                mPhone.setText(cityInfo.getPhone());
                break;
            case 20:
    ...
    private void loadData() {
        SuccinctProgress.showSuccinctProgress(CityInfoInfo.this, "数据请求中···", SuccinctProgress
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        Village v = (Village) gson.fromJson(result.getJSONObject("data").toString
                                (), Village.class);
                        mName.setText(cityInfo.getName());
                        mCun.setText(v.getName());
                        mGrid.setText(gridId);
                        mBz.setText(cityInfo.getBz());
                    } else if ("2".equals(resultCode)) {
                        DialogUtil.showTipsDialog(CityInfoInfo.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(CityInfoInfo.this, R.string.load_fail);
                    }
