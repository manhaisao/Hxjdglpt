 ...
 */
@ContentView(R.layout.aty_cjry_info)
public class CjryInfo extends BaseActivity implements ViewPager.OnPageChangeListener {
    ...
    @ViewInject(R.id.cjr_name)
    private TextView mName;
    @ViewInject(R.id.cjr_cun)
    private TextView mCun;
    @ViewInject(R.id.cjr_grid)
    private TextView mGrid;
    @ViewInject(R.id.cjr_birth)
    private TextView mBirth;
    @ViewInject(R.id.cjr_address)
    private TextView mAddress;
    @ViewInject(R.id.cjr_bz)
            ...
            if (!TextUtils.isEmpty(path[i])) {
                ...
                img.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.setClass(CjryInfo.this, ShowImageActivity.class);
...
//        tvTitle.setText(getFile(position));
    ...
    private void loadData() {
        SuccinctProgress.showSuccinctProgress(CjryInfo.this, "数据请求中···", SuccinctProgress
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        Village v = (Village) gson.fromJson(result.getJSONObject("data").toString
                                (), Village.class);
                        mName.setText(cjry.getName());
                        mCun.setText(v.getName());
                        mGrid.setText(gridId);
                        mBirth.setText(cjry.getCjCode());
                        mAddress.setText(cjry.getCjType());
                        mBz.setText(cjry.getBz());
                    } else if ("2".equals(resultCode)) {
                        DialogUtil.showTipsDialog(CjryInfo.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(CjryInfo.this, R.string.load_fail);
                    }
