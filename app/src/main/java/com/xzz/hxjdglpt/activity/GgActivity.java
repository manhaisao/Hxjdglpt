...
@ContentView(R.layout.aty_gg)
public class GgActivity extends BaseActivity implements AutoListView.OnRefreshListener,
...
//    private List<Gonggao> list = new ArrayList<Gonggao>();
    ...
    private String type = "";
        private String tabNames[] = {"人事任免", "公示栏"};
//
...
//        VolleyRequest.RequestPost(GgActivity.this, url, "queryListByPage", params,
//                new VolleyListenerInterface(GgActivity.this,
...
//                                DialogUtil.showTipsDialog(GgActivity.this);
//                            } else if ("3".equals(resultCode)) {
//                                ToastUtil.show(GgActivity.this, R.string.load_fail);
//                            }
