 ...
 */
@ContentView(R.layout.aty_qfhx_list)
public class QfhxListActivity extends BaseActivity implements AutoListView.OnRefreshListener,
...
//                LogUtil.i(result.toString());
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        DialogUtil.showTipsDialog(QfhxListActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(QfhxListActivity.this, R.string.load_fail);
                    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if (position - 1 < list.size()) {
            ...
            intent.setClass(QfhxListActivity.this, QfhxDtDetailActivity.class);
