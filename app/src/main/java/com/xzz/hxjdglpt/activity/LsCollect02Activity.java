 ...
 * 代办社会保险信息
 */
@ContentView(R.layout.activity_ls_collect_02)
public class LsCollect02Activity extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shbx = (Shbx) bundle.getSerializable("shbx");
        x.view().inject(this);
        initView();
        initData();
    }
    ...
    public void initView() {
        super.initView();
        hXtitle.setText("代办社会保险");
        if(!isAdd){
            id = shbx.getId();
            etBmfzr.setText(shbx.getFzr());
            etFzrdh.setText(shbx.getFzrphone());
            tvJbrNum.setText(shbx.getPs().size()+"");
        }
    }
        ...
        switch (v.getId()) {
            ...
            case R.id.iv_jbr:
                if(id == 0){
                    ...
                    intent.setClass(LsCollect02Activity.this, ListActivity.class);
     ...
     */
    private void formSb() {
        SuccinctProgress.showSuccinctProgress(LsCollect02Activity.this, "数据请求中···", SuccinctProgress
        ...
        if(!isAdd){
            params.put("id",String.valueOf(shbx.getId()));
        }
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        ToastUtil.show(LsCollect02Activity.this, R.string.commit_success);
                    } else if ("2".equals(resultCode)) {
                        DialogUtil.showTipsDialog(LsCollect02Activity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(LsCollect02Activity.this, R.string.load_fail);
                    }
