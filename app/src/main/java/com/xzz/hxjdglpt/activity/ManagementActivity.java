 ...
 */
@ContentView(R.layout.aty_magement)
public class ManagementActivity extends BaseActivity implements View.OnTouchListener {
    ...
    @ViewInject(R.id.m_isns)
    private AppCompatSpinner spIsns;//是否纳税
    @ViewInject(R.id.m_jy_area)
    ...
    @ViewInject(R.id.m_jy_area)
    private EditText edtJyArea;//经营范围
    ...
    @ViewInject(R.id.m_rjgz)
    private EditText edtRjgz;//人均工资
    @ViewInject(R.id.m_jy_nsqk)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        x.view().inject(this);
        tvTitle.setText(getText(R.string.management_info_));
        ...
        edtNsqk.setOnTouchListener(this);
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if ((view.getId() == R.id.m_address && canVerticalScroll(edtCAddress))) {
            view.getParent().requestDisallowInterceptTouchEvent(true);
            if (motionEvent.getAction() == MotionEvent.ACTION_UP) {
                view.getParent().requestDisallowInterceptTouchEvent(false);
            }
        } else if ((view.getId() == R.id.m_jy_nsqk && canVerticalScroll(edtNsqk))) {
            view.getParent().requestDisallowInterceptTouchEvent(true);
            if (motionEvent.getAction() == MotionEvent.ACTION_UP) {
                view.getParent().requestDisallowInterceptTouchEvent(false);
            }
    ...
    @Event(value = {R.id.iv_back, R.id.magement_commit, R.id.c_zcsj}, type = View.OnClickListener.class)
    ...
    public void initData() {
        if (!isAdd) {
            ...
            if (types[0].equals(management.getType())) {
                spQylx.setSelection(0);
            } else if (types[1].equals(management.getType())) {
                spQylx.setSelection(1);
            } else if (types[2].equals(management.getType())) {
                spQylx.setSelection(2);
            } else if (types[3].equals(management.getType())) {
                spQylx.setSelection(3);
            }

            if (isNs[0].equals(management.getIsnas())) {
                spIsns.setSelection(0);
            } else if (isNs[1].equals(management.getIsnas())) {
                spIsns.setSelection(1);
            }

            if (jyArea[0].equals(management.getArea())) {
                spJyArea.setSelection(0);
            } else if (jyArea[1].equals(management.getArea())) {
                spJyArea.setSelection(1);
            } else if (jyArea[2].equals(management.getArea())) {
                spJyArea.setSelection(2);
            } else if (jyArea[3].equals(management.getArea())) {
                spJyArea.setSelection(3);
            } else if (jyArea[4].equals(management.getArea())) {
                spJyArea.setSelection(4);
            } else if (jyArea[5].equals(management.getArea())) {
                spJyArea.setSelection(5);
            }
//            else if (jyArea[6].equals(management.getArea())) {
//                spJyArea.setSelection(6);
//            } else if (jyArea[7].equals(management.getArea())) {
//                spJyArea.setSelection(7);
//            }

            edtName.setText(management.getName());//姓名
            edtNsqk.setText(management.getNsqk());
            edtRjgz.setText(management.getGongzi());//
            edtCAddress.setText(management.getAddress());
            edtLxr.setText(management.getLinkman());
            edtLxrPhone.setText(management.getLinkmanphone());
            edtZgnum.setText(String.valueOf(management.getEmployeenum()));
            edtBz.setText(management.getBz());//备注
            edtSsdw.setText(management.getDanwei());
            edtWgzrr.setText(management.getGridzrr());
            edtWgzrrdh.setText(management.getGridzrrdh());
            tvZcsj.setText(management.getTime());
            if (management.getPicpath() != null) {
                picPath = management.getPicpath();
                SuccinctProgress.showSuccinctProgress(ManagementActivity.this, "图片努力加载中···",
    ...
    public void initView() {
        types = getResources().getStringArray(R.array.gtlx_list);
        ...
        gridView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                if (position == 0 && imageItem.size() == ConstantUtil.ALL_IMAGE_COUNT) { //第一张为默认图片
                    ToastUtil.show(ManagementActivity.this, "图片数已至上限");
...
//                    startActivityForResult(intent, IMAGE_OPEN);
        ...
        public void run() {
            ...
            for (int i = 0; i < ps.length; i++) {
                if (!TextUtils.isEmpty(ps[i])) {
                    mPath.add(ps[i]);
                    HashMap<String, Object> map = new HashMap<String, Object>();
                    map.put("itemImage", BitmapUtil.getNetBitmap(ManagementActivity.this,
    ...
    private void uploadFile(final String path) {
        SuccinctProgress.showSuccinctProgress(ManagementActivity.this, "图片上传中···",
                SuccinctProgress.THEME_ULTIMATE, false, true);
        ...
        post = x.http().post(params, new Callback.CommonCallback<JSONObject>() {
            ...
            public void onSuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        DialogUtil.showTipsDialog(ManagementActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(ManagementActivity.this, R.string.load_fail);
                    }
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                SuccinctProgress.dismiss();
                ToastUtil.show(ManagementActivity.this, R.string.upload_image_fail);
            }
     ...
     */
    private void commit() {
        String url = ConstantUtil.BASE_URL + "/management/commitManagement";
...
//        params.put("type", spQylx.getSelectedItem().toString());
        ...
        SuccinctProgress.showSuccinctProgress(ManagementActivity.this, "数据提交中···",
                SuccinctProgress.THEME_ULTIMATE, false, true);
        VolleyRequest.RequestPost(this, url, "management_commit", params, new
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    String resultCode = result.getString("resultCode");
                    if ("1".equals(resultCode)) {
                        ToastUtil.show(ManagementActivity.this, R.string.commit_success);
                        finish();
                    } else if ("2".equals(resultCode)) {
                        DialogUtil.showTipsDialog(ManagementActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(ManagementActivity.this, R.string.commit_fail);
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
     ...
     */
    private void update() {
        String url = ConstantUtil.BASE_URL + "/management/updateManagement";
        Map<String, String> params = new HashMap<String, String>();
        params.put("userId", user.getUserId());
        params.put("token", user.getToken());
        params.put("id", management.getId());
        ...
        VolleyRequest.RequestPost(this, url, "updateManagement", params, new
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    String resultCode = result.getString("resultCode");
                    if ("1".equals(resultCode)) {
                        ToastUtil.show(ManagementActivity.this, R.string.modify_success);
                        finish();
                    } else if ("2".equals(resultCode)) {
                        DialogUtil.showTipsDialog(ManagementActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(ManagementActivity.this, R.string.modify_fail);
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
