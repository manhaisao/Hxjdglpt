 ...
 */
@ContentView(R.layout.aty_chengpin_info)
public class ChengpinInfo extends BaseActivity {
    ...
    public void initView() {
        ...
        gridView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                intent.setClass(ChengpinInfo.this, ShowImageActivity.class);
...
//            loadData();
        mName.setText(chengpin.getName());
        mGrid.setText(chengpin.getGridid());
        mQylx.setText(chengpin.getType());
        mNsqk.setText(chengpin.getAddress());
        mZrr.setText(chengpin.getGridzrr());
        mZrrdh.setText(chengpin.getGridzrrphone());
        mDw.setText(chengpin.getDanwei());
        mBz.setText(chengpin.getBz());
        mFr.setText(chengpin.getFr());
        mFrdh.setText(chengpin.getFrphone());
        mAqzrr.setText(chengpin.getAq());
        mAqzrrdh.setText(chengpin.getAqphone());
        if (chengpin.getFilepath() != null) {
            picPath = chengpin.getFilepath();
            SuccinctProgress.showSuccinctProgress(ChengpinInfo.this, "图片努力加载中···",
        ...
        public void run() {
            ...
            for (int i = 0; i < ps.length; i++) {
                if (!TextUtils.isEmpty(ps[i])) {
                    ...
                    map.put("itemImage", BitmapUtil.getNetBitmap(ChengpinInfo.this, ConstantUtil
    ...
    private void loadData() {
        SuccinctProgress.showSuccinctProgress(ChengpinInfo.this, "数据请求中···", SuccinctProgress
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        DialogUtil.showTipsDialog(ChengpinInfo.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(ChengpinInfo.this, R.string.load_fail);
                    }
    ...
    private void onClick(View v) {
        Intent intent = new Intent();
        intent.setClass(ChengpinInfo.this, XfaqActivity.class);
        intent.putExtra("type", type);
        intent.putExtra("cType", "4");
        intent.putExtra("pId", String.valueOf(chengpin.getId()));
        switch (v.getId()) {
            case R.id.iv_back:
                finish();
                break;
