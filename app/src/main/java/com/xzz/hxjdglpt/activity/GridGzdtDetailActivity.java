 ...
 */
@ContentView(R.layout.aty_grid_gzdt_detail)
public class GridGzdtDetailActivity extends BaseActivity {
    ...
    @ViewInject(R.id.gzdt_fbr_detail)
...
//                laycljg.setVisibility(View.GONE);
    ...
    public void initData() {
        gridGzdt = getIntent().getParcelableExtra("gzdt");
        tvTime.setText(gridGzdt.getFbsj());
        tvNoTitle.setText(gridGzdt.getTitle());
        tvContent.setText(gridGzdt.getContent());
        tvQuestion.setText(gridGzdt.getQuestion());
        tvResult.setText(gridGzdt.getResult());
        tvAddress.setText(gridGzdt.getFbaddress());
        tvFbr.setText(gridGzdt.getFbrName());
        initGridFj();
    }
    ...
    private void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.hx_title_right:
                ...
                final Dialog dialog = new Dialog(GridGzdtDetailActivity.this);
    ...
    private void delData() {
        SuccinctProgress.showSuccinctProgress(GridGzdtDetailActivity.this, "数据提交中···",
                SuccinctProgress.THEME_ULTIMATE, false, true);
        String url = "";
        HashMap<String, String> params = new HashMap<>();
        url = ConstantUtil.BASE_URL + "/gridGzdt/deleteGridGzdt";
        params.put("id", String.valueOf(gridGzdt.getId()));
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ToastUtil.show(GridGzdtDetailActivity.this, R.string.del_success);
                        finish();
                    } else if ("2".equals(resultCode)) {
                        DialogUtil.showTipsDialog(GridGzdtDetailActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(GridGzdtDetailActivity.this, R.string.del_fail);
                    }
    ...
    private void initGridFj() {
        ...
        if (!TextUtils.isEmpty(gridGzdt.getFilepath())) {
            final String[] path = gridGzdt.getFilepath().split(",");
            String[] fileName = gridGzdt.getFilename().split(",");
            if (path.length == fileName.length) {
                ...
                for (int i = 0; i < path.length; i++) {
                    if (!TextUtils.isEmpty(fileName[i]) || !TextUtils.isEmpty(path[i])) {
                        ...
                        int pxValue = DensityUtil.dip2px(GridGzdtDetailActivity.this, 5);
                        ...
                        tv.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                if (fName.endsWith(".jpg") || fName.endsWith(".png") || fName
                                    ...
                                    intent.setClass(GridGzdtDetailActivity.this,
                                            ShowImageActivity.class);
                                    startActivity(intent);
                                } else {
                                    File file = new File(ConstantUtil.BASE_PATH + fName);
                                    if (file.exists()) {
                                        Intent intent = new Intent(GridGzdtDetailActivity.this,
                                        ...
                                        final Dialog dialog = new Dialog(GridGzdtDetailActivity
                                                .this);
                                        ...
                                        // .zxtz_detail_tip));
                                        tvCon.setText(GridGzdtDetailActivity.this.getText(R
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case OkHttpManager.DOWNLOAD_SUCCESS:
                    ToastUtil.show(GridGzdtDetailActivity.this, R.string.download_success);
                    times = 0;
                    dialog.dismiss();
                    break;
                case OkHttpManager.DOWNLOAD_FAIL:
                    ToastUtil.show(GridGzdtDetailActivity.this, R.string.download_failed);
                    times = 0;
                    dialog.dismiss();
                    break;
                case OkHttpManager.NETWORK_FAILURE:
                    ToastUtil.show(GridGzdtDetailActivity.this, R.string.net_unuser);
                    times = 0;
                    dialog.dismiss();
                    break;
                default:
