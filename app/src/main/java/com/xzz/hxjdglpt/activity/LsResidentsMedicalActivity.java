 ...
 * 城乡居民医疗保险
 */
@ContentView(R.layout.activity_ls_residents_medical)
public class LsResidentsMedicalActivity extends BaseActivity {
    ...
    public void initView() {
        super.initView();
        hXtitle.setText(R.string.ls_cx_02_title);
        //初始化recyleView
        ...
        adapter.setItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(LsResidentsMedicalActivity.this,LsMedicalVillageActivity.class);
    ...
    public void getVillage() {
        SuccinctProgress.showSuccinctProgress(LsResidentsMedicalActivity.this, "请求数据中···", SuccinctProgress
...
//                                            g.setId("jly");
                                ...
                                DialogUtil.showTipsDialog(LsResidentsMedicalActivity.this);
                            } else if ("3".equals(resultCode)) {
                                ToastUtil.show(LsResidentsMedicalActivity.this, R.string.load_fail);
                            }
     ...
     * 获取医疗保险信息
     */
    private void getResidentsMedical() {
        String url = ConstantUtil.BASE_URL + "/xshs/queryinfoBytype?type=2";
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        //设置值
                        tvMedicalNum.setText(String.valueOf(insrurenNum));
