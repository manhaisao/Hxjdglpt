 ...
 */
@ContentView(R.layout.aty_roupidouzhi)
public class RoupidouzhiActivity extends BaseActivity implements View.OnTouchListener {
    ...
    public void initData() {
        if (!isAdd) {
            ...
            if (types[0].equals(roupidouzhi.getType())) {
                spQylx.setSelection(0);
            } else if (types[1].equals(roupidouzhi.getType())) {
                spQylx.setSelection(1);
            }

            edtLxr.setText(roupidouzhi.getJyz());
            edtLxrPhone.setText(roupidouzhi.getAddress());
            tvZcsj.setText(roupidouzhi.getTime());
            edtSsdw.setText(roupidouzhi.getDanwei());
            edtWgzrr.setText(roupidouzhi.getGridzrr());
            edtWgzrrdh.setText(roupidouzhi.getZrrphone());
            edtName.setText(roupidouzhi.getName());//姓名
            edtBz.setText(roupidouzhi.getBz());//备注
            if (roupidouzhi.getFilepath() != null) {
                picPath = roupidouzhi.getFilepath();
                SuccinctProgress.showSuccinctProgress(RoupidouzhiActivity.this, "图片努力加载中···",
    ...
    public void initView() {
        types = getResources().getStringArray(R.array.roupidouzhi);
        ...
        gridView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                if (position == 0 && imageItem.size() == 3) { //第一张为默认图片
                    ToastUtil.show(RoupidouzhiActivity.this, "图片数已至上限");
...
//                    startActivityForResult(intent, IMAGE_OPEN);
                    ...
                    intent.setClass(RoupidouzhiActivity.this, ShowImageActivity.class);
        ...
        public void run() {
            ...
            for (int i = 0; i < ps.length; i++) {
                if (!TextUtils.isEmpty(ps[i])) {
                    mPath.add(ps[i]);
                    HashMap<String, Object> map = new HashMap<String, Object>();
                    map.put("itemImage", BitmapUtil.getNetBitmap(RoupidouzhiActivity.this,
    ...
    protected void dialog(final int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(RoupidouzhiActivity.this);
    ...
    private void uploadFile(final String path) {
        SuccinctProgress.showSuccinctProgress(RoupidouzhiActivity.this, "图片上传中···", SuccinctProgress
        ...
        post = x.http().post(params, new Callback.CommonCallback<JSONObject>() {
            ...
            public void onSuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        DialogUtil.showTipsDialog(RoupidouzhiActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(RoupidouzhiActivity.this, R.string.load_fail);
                    }
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                SuccinctProgress.dismiss();
                ToastUtil.show(RoupidouzhiActivity.this, R.string.upload_image_fail);
            }
        ...
        switch (v.getId()) {
            ...
            case R.id.c_commit:
                if (TextUtils.isEmpty(edtName.getText().toString())) {
                    ToastUtil.show(RoupidouzhiActivity.this, "请输入商户名称！");
                    return;
                }
                if (isAdd) {
                    commit();
     ...
     */
    private void commit() {
        String url = ConstantUtil.BASE_URL + "/rpdz/commitData";
        ...
        SuccinctProgress.showSuccinctProgress(RoupidouzhiActivity.this, "请求提交中···", SuccinctProgress
                .THEME_ULTIMATE, false, true);
                ...
                VolleyListenerInterface(this, VolleyListenerInterface.mListener,
                    ...
                    public void onMySuccess(JSONObject result) {
                        ...
                        try {
                            String resultCode = result.getString("resultCode");
                            if ("1".equals(resultCode)) {
                                ToastUtil.show(RoupidouzhiActivity.this, R.string.commit_success);
                                finish();
                            } else if ("2".equals(resultCode)) {
                                DialogUtil.showTipsDialog(RoupidouzhiActivity.this);
                            } else if ("3".equals(resultCode)) {
                                ToastUtil.show(RoupidouzhiActivity.this, R.string.commit_fail);
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
     ...
     */
    private void update() {
        String url = ConstantUtil.BASE_URL + "/rpdz/updateData";
        Map<String, String> params = new HashMap<String, String>();
        params.put("userId", user.getUserId());
        params.put("token", user.getToken());
        params.put("id", String.valueOf(roupidouzhi.getId()));
        params.put("gridid", gridId);
        params.put("type", spQylx.getSelectedItem().toString());
        if (!TextUtils.isEmpty(edtLxr.getText().toString())) {
            params.put("jyz", edtLxr.getText().toString());
        ...
        VolleyRequest.RequestPost(this, url, "updateCompany", params, new VolleyListenerInterface
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    String resultCode = result.getString("resultCode");
                    if ("1".equals(resultCode)) {
                        ToastUtil.show(RoupidouzhiActivity.this, R.string.modify_success);
                        finish();
                    } else if ("2".equals(resultCode)) {
                        DialogUtil.showTipsDialog(RoupidouzhiActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(RoupidouzhiActivity.this, R.string.modify_fail);
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
