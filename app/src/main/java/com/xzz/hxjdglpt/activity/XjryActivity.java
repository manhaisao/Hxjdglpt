 ...
 */
@ContentView(R.layout.aty_xjry)
public class XjryActivity extends BaseActivity {
    ...
    private EditText edtZzmm;//政治面貌
    @ViewInject(R.id.jsbhz_jhrgx)
    private EditText edtDw;//单位
    @ViewInject(R.id.jsbhz_jhrphone)
    private EditText edtWhcd;//文化程度
    @ViewInject(R.id.jsbhz_xjmc)
    private EditText edtXjmc;//邪教名称
    @ViewInject(R.id.jsbhz_jtime)
    private TextView edtJtime;//参加时间
    ...
    public void initData() {
        if (!isAdd) {
            ...
            edtName.setText(xjry.getName());//姓名
            edtAddress.setText(xjry.getAddress());//地址
            edtCode.setText(xjry.getSfzh());
            edtPhone.setText(xjry.getPhone());
            edtDw.setText(xjry.getDw());
            edtJtime.setText(xjry.getjTime());
            edtWhcd.setText(xjry.getWhcd());
            edtXjmc.setText(xjry.getXjName());
            edtZzmm.setText(xjry.getZzmm());
            getXzCount();
        } else {
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    ...
                    if ("1".equals(resultCode)) {
                        ...
                        DialogUtil.showTipsDialog(XjryActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(XjryActivity.this, R.string.load_fail);
                    }
     ...
     */
    private void commit() {
        String url = ConstantUtil.BASE_URL + "/xjry/commitXjry";
        ...
        if (!TextUtils.isEmpty(edtDw.getText().toString())) {
            params.put("dw", edtDw.getText().toString());
        } else {
            params.put("dw", "");
        }
        ...
        if (!TextUtils.isEmpty(edtJtime.getText().toString())) {
            params.put("jTime", edtJtime.getText().toString());
        } else {
            params.put("jTime", "");
        }
        if (!TextUtils.isEmpty(edtWhcd.getText().toString())) {
            params.put("whcd", edtWhcd.getText().toString());
        } else {
            params.put("whcd", "");
        }
        if (!TextUtils.isEmpty(edtXjmc.getText().toString())) {
            params.put("xjName", edtXjmc.getText().toString());
        } else {
            params.put("xjName", "");
        }
        if (!TextUtils.isEmpty(edtZzmm.getText().toString())) {
            params.put("zzmm", edtZzmm.getText().toString());
        } else {
            params.put("zzmm", "");
        }
        params.put("bz", "");
        SuccinctProgress.showSuccinctProgress(this, "数据提交中···", SuccinctProgress.THEME_ULTIMATE,
                false, true);
        VolleyRequest.RequestPost(this, url, "commitXjry", params, new VolleyListenerInterface
                (this, VolleyListenerInterface.mListener, VolleyListenerInterface.mErrorListener) {
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    String resultCode = result.getString("resultCode");
                    if ("1".equals(resultCode)) {
                        ToastUtil.show(XjryActivity.this, R.string.commit_success);
                        finish();
                    } else if ("2".equals(resultCode)) {
                        DialogUtil.showTipsDialog(XjryActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(XjryActivity.this, R.string.commit_fail);
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    @Event(value = {R.id.jsbhz_commit, R.id.iv_back, R.id.jsbhz_gkxz_add, R.id.jsbhz_jtime}, type
    ...
    private void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.jsbhz_gkxz_add:
                ...
                intent.setClass(XjryActivity.this, GkxzListActivity.class);
                intent.putExtra("type", "7");
                intent.putExtra("pId", String.valueOf(xjry.getId()));
                startActivity(intent);
                break;
            case R.id.jsbhz_jtime:
    ...
    public void onStop() {
        super.onStop();
        BaseApplication.getRequestQueue().cancelAll("commitXjry");
        BaseApplication.getRequestQueue().cancelAll("updateaXjry");
        BaseApplication.getRequestQueue().cancelAll("getCount");
    }


    private void update() {
        String url = ConstantUtil.BASE_URL + "/xjry/updateaXjry";
        Map<String, String> params = new HashMap<String, String>();
        params.put("userId", user.getUserId());
        params.put("token", user.getToken());
        params.put("id", String.valueOf(xjry.getId()));
        params.put("gridId", gridId);
        if (!TextUtils.isEmpty(edtName.getText().toString())) {
            params.put("name", edtName.getText().toString());
        } else {
        ...
        SuccinctProgress.showSuccinctProgress(this, "数据修改中···", SuccinctProgress.THEME_ULTIMATE,
                false, true);
        VolleyRequest.RequestPost(this, url, "updateaXjry", params, new VolleyListenerInterface
                (this, VolleyListenerInterface.mListener, VolleyListenerInterface.mErrorListener) {
            ...
            public void onMySuccess(JSONObject result) {
                ...
                try {
                    String resultCode = result.getString("resultCode");
                    if ("1".equals(resultCode)) {
                        ToastUtil.show(XjryActivity.this, R.string.modify_success);
                        finish();
                    } else if ("2".equals(resultCode)) {
                        DialogUtil.showTipsDialog(XjryActivity.this);
                    } else if ("3".equals(resultCode)) {
                        ToastUtil.show(XjryActivity.this, R.string.modify_fail);
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    public void showBottoPopupWindow() {
        ...
        mPopupWindow.showAtLocation(edtJtime, Gravity.CENTER, 0, 0);
        ...
        tv_ensure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                edtJtime.setText(beginTime.substring(0, 10));
                mPopupWindow.dismiss();
                backgroundAlpha(1f);
            }
        });
