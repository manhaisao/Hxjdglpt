...
@ContentView(R.layout.fragment_cj)
public class CjFragment extends Fragment {
    ...
    @Event(value = {R.id.cj_01, R.id.cj_02, R.id.cj_03, R.id.cj_04, R.id.cj_05, R.id.cj_06, R.id
            .cj_07}, type = View.OnClickListener.class)
