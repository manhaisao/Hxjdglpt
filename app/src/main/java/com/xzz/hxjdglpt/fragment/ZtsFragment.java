...
@ContentView(R.layout.fragment_zts)
public class ZtsFragment extends Fragment {
    ...
    @Event(value = {R.id.zt_01, R.id.zt_02, R.id.zt_03, R.id.zt_04, R.id.zt_05}, type = View
