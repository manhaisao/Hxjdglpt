...
package com.xzz.hxjdglpt.server.network.download;
...
import com.xzz.hxjdglpt.server.network.http.AsyncHttpClient;
import com.xzz.hxjdglpt.server.network.http.AsyncHttpResponseHandler;
import com.xzz.hxjdglpt.server.network.http.BreakpointHttpResponseHandler;
