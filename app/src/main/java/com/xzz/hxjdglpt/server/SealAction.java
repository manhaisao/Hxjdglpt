package com.xzz.hxjdglpt.server;
...
import com.xzz.hxjdglpt.server.network.http.RequestParams;
import com.xzz.hxjdglpt.server.request.AddGroupMemberRequest;
import com.xzz.hxjdglpt.server.request.AddToBlackListRequest;
import com.xzz.hxjdglpt.server.request.AgreeFriendsRequest;
import com.xzz.hxjdglpt.server.request.ChangePasswordRequest;
import com.xzz.hxjdglpt.server.request.CheckPhoneRequest;
import com.xzz.hxjdglpt.server.request.CreateGroupRequest;
import com.xzz.hxjdglpt.server.request.DeleteFriendRequest;
import com.xzz.hxjdglpt.server.request.DeleteGroupMemberRequest;
import com.xzz.hxjdglpt.server.request.DismissGroupRequest;
import com.xzz.hxjdglpt.server.request.FriendInvitationRequest;
import com.xzz.hxjdglpt.server.request.JoinGroupRequest;
import com.xzz.hxjdglpt.server.request.LoginRequest;
import com.xzz.hxjdglpt.server.request.QuitGroupRequest;
import com.xzz.hxjdglpt.server.request.RegisterRequest;
import com.xzz.hxjdglpt.server.request.RemoveFromBlacklistRequest;
import com.xzz.hxjdglpt.server.request.RestPasswordRequest;
import com.xzz.hxjdglpt.server.request.SendCodeRequest;
import com.xzz.hxjdglpt.server.request.SetFriendDisplayNameRequest;
import com.xzz.hxjdglpt.server.request.SetGroupDisplayNameRequest;
import com.xzz.hxjdglpt.server.request.SetGroupNameRequest;
import com.xzz.hxjdglpt.server.request.SetGroupPortraitRequest;
import com.xzz.hxjdglpt.server.request.SetNameRequest;
import com.xzz.hxjdglpt.server.request.SetPortraitRequest;
import com.xzz.hxjdglpt.server.request.VerifyCodeRequest;
import com.xzz.hxjdglpt.server.response.AddGroupMemberResponse;
import com.xzz.hxjdglpt.server.response.AddToBlackListResponse;
import com.xzz.hxjdglpt.server.response.AgreeFriendsResponse;
import com.xzz.hxjdglpt.server.response.ChangePasswordResponse;
import com.xzz.hxjdglpt.server.response.CheckPhoneResponse;
import com.xzz.hxjdglpt.server.response.CreateGroupResponse;
import com.xzz.hxjdglpt.server.response.DefaultConversationResponse;
import com.xzz.hxjdglpt.server.response.DeleteFriendResponse;
import com.xzz.hxjdglpt.server.response.DeleteGroupMemberResponse;
...
import com.xzz.hxjdglpt.server.response.GetFriendInfoByIDResponse;
...
import com.xzz.hxjdglpt.server.response.GetUserInfoByIdResponse;
import com.xzz.hxjdglpt.server.response.GetUserInfoByPhoneResponse;
import com.xzz.hxjdglpt.server.response.GetUserInfosResponse;
import com.xzz.hxjdglpt.server.response.JoinGroupResponse;
import com.xzz.hxjdglpt.server.response.LoginResponse;
import com.xzz.hxjdglpt.server.response.QiNiuTokenResponse;
import com.xzz.hxjdglpt.server.response.QuitGroupResponse;
import com.xzz.hxjdglpt.server.response.RegisterResponse;
import com.xzz.hxjdglpt.server.response.RemoveFromBlackListResponse;
import com.xzz.hxjdglpt.server.response.RestPasswordResponse;
import com.xzz.hxjdglpt.server.response.SendCodeResponse;
import com.xzz.hxjdglpt.server.response.SetFriendDisplayNameResponse;
...
import com.xzz.hxjdglpt.server.response.SetNameResponse;
import com.xzz.hxjdglpt.server.response.SetPortraitResponse;
import com.xzz.hxjdglpt.server.response.SyncTotalDataResponse;
import com.xzz.hxjdglpt.server.response.UserRelationshipResponse;
import com.xzz.hxjdglpt.server.response.VerifyCodeResponse;
import com.xzz.hxjdglpt.server.response.VersionResponse;
...
public class SealAction extends BaseAction {
     ...
     */
    public CheckPhoneResponse checkPhoneAvailable(String region, String phone) throws
            HttpException {
    ...
    * */
     ...
     * @throws HttpException
     */
    public VerifyCodeResponse verifyCode(String region, String phone, String code) throws
            HttpException {
     ...
     * @throws HttpException
     */
    public RegisterResponse register(String nickname, String password, String verification_token)
            throws HttpException {
        String url = getURL("user/register");
        StringEntity entity = null;
        try {
            entity = new StringEntity(JsonMananger.beanToJson(new RegisterRequest(nickname,
                    password, verification_token)), ENCODING);
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
     ...
     * @throws HttpException
     */
    public RestPasswordResponse restPassword(String password, String verification_token) throws
            HttpException {
        String uri = getURL("user/reset_password");
        String json = JsonMananger.beanToJson(new RestPasswordRequest(password,
                verification_token));
        StringEntity entity = null;
        try {
            entity = new StringEntity(json, ENCODING);
     ...
     * @throws HttpException
     */
    public GetUserInfoByPhoneResponse getUserInfoFromPhone(String region, String phone) throws
            HttpException {
     ...
     * @throws HttpException
     */
    public FriendInvitationResponse sendFriendInvitation(String userid, String addFriendMessage)
            throws HttpException {
        String url = getURL("friendship/invite");
        String json = JsonMananger.beanToJson(new FriendInvitationRequest(userid,
                addFriendMessage));
        StringEntity entity = null;
        try {
            entity = new StringEntity(json, ENCODING);
     ...
     * @throws HttpException
     */
    public CreateGroupResponse createGroup(String name, List<String> memberIds) throws
            HttpException {
    ...
    public GetGroupResponse getGroups() throws HttpException {
        String url = getURL("m_mi/queryGroupUser");
...
//        String result = httpManager.get(mContext, url);
     ...
     * @throws HttpException
     */
    public AddGroupMemberResponse addGroupMember(String groupId, List<String> memberIds) throws
            HttpException {
     ...
     * @throws HttpException
     */
    public DeleteGroupMemberResponse deleGroupMember(String groupId, List<String> memberIds)
            throws HttpException {
     ...
     * @throws HttpException
     */
    public SetGroupDisplayNameResponse setGroupDisplayName(String groupId, String displayName)
            throws HttpException {
     ...
     * @throws HttpException
     */
    public SetFriendDisplayNameResponse setFriendDisplayName(String friendId, String displayName)
            throws HttpException {
        String url = getURL("friendship/set_display_name");
        String json = JsonMananger.beanToJson(new SetFriendDisplayNameRequest(friendId,
                displayName));
        StringEntity entity = null;
        try {
            entity = new StringEntity(json, ENCODING);
